...
unique_lengths = {i: len([0 for _, v in length_map if v == i]) for i in set([i[1] for i in length_map])}
...
Z = sorted(difficulty_map, key=lambda x: x[1])[::-1][0:3000]  # first 3k only
